...
DROP PROCEDURE IF EXISTS sp_actualizar_usuario(INTEGER, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, INTEGER, BOOLEAN, INTEGER);
...
DROP PROCEDURE IF EXISTS sp_actualizar_usuario(INTEGER, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, INTEGER, INTEGER, BOOLEAN, INTEGER);
